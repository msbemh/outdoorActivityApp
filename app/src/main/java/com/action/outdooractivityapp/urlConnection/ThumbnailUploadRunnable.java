...
public class ThumbnailUploadRunnable implements Runnable {
    ...
    private static final String TAG = "ThumbnailUploadRunnable";
    ...
    public ThumbnailUploadRunnable(Context context){
    ...
    //서버 이미지 경로 보내주기
    public String getServerImageRoute(){
        return this.serverImageRoute;
    }
