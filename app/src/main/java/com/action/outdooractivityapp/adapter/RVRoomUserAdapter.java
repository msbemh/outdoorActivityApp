...
public class RVRoomUserAdapter extends RecyclerView.Adapter<RecyclerView.ViewHolder> {
    private Context context;
    private List<Map> items;
    private int itemLayoutMapUser;
    private Intent intent;
    private static final String TAG = "RVRoomUserAdapter";
    private MapView mapView;

    public RVRoomUserAdapter(Context context, List<Map> items, int itemLayoutMapUser) {
